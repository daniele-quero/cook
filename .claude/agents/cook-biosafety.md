...
- Persona del ruolo (sorgente di verità): [docs/agent-personas/cook-biosafety.md](../../docs/agent-personas/cook-biosafety.md). Prima di agire, usa `Read` sul file completo.
- Istruzioni ACE del ruolo: [.github/instructions/ace-cook-biosafety.instructions.md](../../.github/instructions/ace-cook-biosafety.instructions.md). Leggile con `Read`; se non sono raggiungibili, fermati e segnala il blocco.
