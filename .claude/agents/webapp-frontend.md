...
- Persona del ruolo (sorgente di verità): [docs/agent-personas/webapp-frontend.md](../../docs/agent-personas/webapp-frontend.md). Prima di agire, usa `Read` sul file completo.
- Istruzioni ACE del ruolo: [.github/instructions/ace-webapp-frontend.instructions.md](../../.github/instructions/ace-webapp-frontend.instructions.md). Leggile con `Read`; se non sono raggiungibili, fermati e segnala il blocco.
