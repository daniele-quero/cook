...
**Prima di procedere**, esegui `read_file` su [`.github/instructions/ace-webapp-frontend.instructions.md`](../../.github/instructions/ace-webapp-frontend.instructions.md): contiene lezioni operative specifiche per questo ruolo, accumulate dal ciclo ACE. Applicale se rilevanti al task corrente, citando l'id tra parentesi quadre se lo fai.
