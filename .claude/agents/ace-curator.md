...
[ace/scripts/apply_delta.js](../../ace/scripts/apply_delta.js) le applica solo
dopo che [ace/scripts/gate.js](../../ace/scripts/gate.js) le ha validate
(controlli meccanici + sign-off umano esplicito — vedi quel file per i
limiti del replay/regressione automatizzati). Vedi
[ace/README.md](../../ace/README.md) per il ciclo completo.
...
prodotte dal reflector (vedi [reflector.md](../../ace/prompts/reflector.md)) e decidi, per
...
prima di `apply_delta` (vedi [warden.md](../../ace/prompts/warden.md)) — la soglia decide
