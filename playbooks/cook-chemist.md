# Playbook — cook-chemist

Bullet specifici per l'agente **cook-chemist** (chimico alimentare —
reazioni chimiche, gastronomia molecolare, proprietà degli ingredienti).
Vedi [Cook-chemist.agent.md](../.github/agents/Cook-chemist.agent.md) per
la costituzione (ruolo/tool/permessi), separata da questo file.
