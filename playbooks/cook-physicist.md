# Playbook — cook-physicist

Bullet specifici per l'agente **cook-physicist** (fisico — trasferimento di
calore, termodinamica, pressione, texture, emulsioni fisiche). Vedi
[Cook-physicist.agent.md](../.github/agents/Cook-physicist.agent.md) per la
