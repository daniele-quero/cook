# Playbook — webapp-backend

Bullet specifici per l'agente **webapp-backend** (sviluppatore backend —
Next.js Route Handlers, integrazione AI Gateway, gestione env/secrets,
streaming SSE). Vedi [Webapp-backend.agent.md](../.github/agents/Webapp-backend.agent.md)
