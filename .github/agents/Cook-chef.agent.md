...
- Persona del ruolo (sorgente di verità): [docs/agent-personas/cook-chef.md](../../docs/agent-personas/cook-chef.md). Prima di agire, usa `view` nell'Agent Host VS Code oppure `read` nei runtime Copilot compatibili sul file completo.
- Istruzioni ACE del ruolo: [.github/instructions/ace-cook-chef.instructions.md](../instructions/ace-cook-chef.instructions.md). Leggile con `view`/`read`; se non sono raggiungibili, fermati e segnala il blocco.
